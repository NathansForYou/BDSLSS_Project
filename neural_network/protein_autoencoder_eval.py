...
if len(t_test[0]) == len(encode_decode[0]) and len(t_test) == len(encode_decode):
    print("Input test data length preserved! OK")
#Squared difference metrics
...
print(sess.run(accuracy, feed_dict={x: y_pred, y_: y_true}))
